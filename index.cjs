...
__export(src_exports, {
  ...
  createClientAnalytics: () => createClientAnalytics,
  createServerAnalytics: () => createServerAnalytics,
  isTrackedHost: () => isTrackedHost,
  sanitizeBeacon: () => sanitizeBeacon,
  toEventProps: () => toEventProps,
  toPathAndQuery: () => toPathAndQuery,
  toTrackedReferrer: () => toTrackedReferrer,
  toTrackedUrl: () => toTrackedUrl
});
